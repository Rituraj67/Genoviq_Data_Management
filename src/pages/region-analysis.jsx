      ...
      >
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          ...
          <Card className="mb-6">
            ...
            {regionData.length > 0 && Object.keys(regionDataOverall).length > 0 &&<CompanyTable filename={`${region.name}_${manager.name}_${company.name}_${selectedYear}-${selectedYear+1}`} data={[...regionData, regionDataOverall]} columns={columns} selectedYear={selectedYear} />}
          </Card>
