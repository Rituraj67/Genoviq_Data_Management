    ...
    <div className="min-h-screen pt-32 px-4 bg-gray-50">
      ...
      >
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          ...
          <Card className="mb-6">
            <CompanyTable filename={`${employee.name}_${region.name}_${manager.name}_${company.name}_${selectedYear}-${selectedYear+1}`} data={employeeData} selectedYear={selectedYear} columns={columns} />
          </Card>
